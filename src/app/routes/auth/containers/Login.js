            ...
            <div className="row">
              ...
              <div className="col-xs-12 col-sm-12 col-md-5 col-lg-4">
                <div className="well no-padding">
                  <UiValidate>
                     <form action="http://localhost:3000/"  method="post" id="login-form" className="smart-form client-form">
					 <header>
                        Sign In
                      </header>
                      <fieldset>
                ...
                <ul className="list-inline text-center">
                  <li>
                    <a href="#/social/analytics" className="btn btn-primary btn-circle"><i className="fa fa-facebook"/></a>
                  </li>
                  <li>
